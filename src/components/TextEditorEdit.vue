...
export default {
    ...
    setup(props) {
        ...
        const editorData = ref(props.data[1].noticData);
        ...
        let imgNotic = ref(props.data[1].imgNotic)
        let titleNotic = ref(props.data[1].titleNotic)
        let btnText = ref('ویرایش کردن اطلاعیه')
        ...
        function addNoticHandler() {
            if (!editorData.value || !imgNotic.value || !titleNotic.value) {
                ...
                btnText.value = "درحال ویرایش کردن اطلاعیه..."
                fetch(`https://payambar-azam-a7b19-default-rtdb.firebaseio.com/notics/${props.data[0]}.json`, {
                    ...
                    .then(res => {
                        btnText.value = "ویرایش کردن اطلاعیه"
                        alertText.value = "اطلاعیه ویرایش شد!"
                        showAlert.value = true
